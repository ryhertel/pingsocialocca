  ...
  return (
    <section className="relative pt-32 pb-20 sm:pb-28 px-6 flex flex-col items-center text-center">
      ...
      <motion.div
        ...
        style={{ borderColor: 'hsl(var(--glow-primary) / 0.3)' }}
        className="relative mt-16 w-full max-w-lg aspect-video rounded-2xl border bg-card/50 backdrop-blur-sm overflow-hidden shadow-[0_0_80px_-20px_hsl(var(--glow-primary)/0.15)] transition-[box-shadow,border-color] duration-[400ms] ease-in-out"
      >
        <FaceCanvas />
